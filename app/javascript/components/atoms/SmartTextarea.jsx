...
class SmartTextarea extends Component {
  ...
  onmousemove() {
    const selection = this.input.value.slice(
  ...
  render() {
    const styleMouseOver = this.state.onMouseOver
      ? this.props.styleMouseOver
      : {};
    ...
    return (
      <div
        ...
        style={styleDiv}
        onMouseOver={e =>
          this.setState({ onMouseOver: true }, this.props.onMouseOver(e))
        }
        onMouseOut={e =>
          this.setState({ onMouseOver: false }, this.props.onMouseOut(e))
        }
